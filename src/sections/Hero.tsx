  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={440} rotation={79} shouldOrbit orbitDuration="46s" shouldSpin spinDuration="6s">
        ...
        <HeroOrbit size={550} rotation={20} shouldOrbit orbitDuration="44s" shouldSpin spinDuration="10s">
          <StarIcon className="size-12 text-emerald-300/80" />
        </HeroOrbit>

        <HeroOrbit size={590} rotation={98} shouldOrbit orbitDuration="42s" shouldSpin spinDuration="8s">
        ...
        <HeroOrbit size={710} rotation={144} shouldOrbit orbitDuration="38s" shouldSpin spinDuration="10s">
          <SparkleIcon className="size-14 text-emerald-300/20" />
        </HeroOrbit>

        <HeroOrbit size={720} rotation={85} shouldOrbit orbitDuration="32s">
          <div className="size-3 bg-emerald-300/20 rounded-full" />
        </HeroOrbit>
      ...
      <div className="container">
        <div className="flex flex-col items-center">
            ...
            <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg">
              <div className="bg-green-500 size-2.5 rounded-full relative"><div className="bg-green-500 rounded-full absolute inset-0 animate-ping-large"></div></div>
              <div className="text-sm font-medium">Available for new Projects</div>
            </div>
        </div>
      <div className="max-w-lg mx-auto">
        <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Building Exceptional User Experiences</h1>
        <p className="mt-4 text-center text-white/60 md:text-lg">I specialize in transforming designs into functional web applications.</p>
      </div>
